      ...
      <main className="container py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Here's what's happening with your database reactivation campaigns
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Set up your first campaign to start reactivating your database
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              <Button className="h-24 flex-col gap-2" variant="outline" disabled>
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground">Import CSV or connect</div>
                </div>
              </Button>
              ...
              <Button className="h-24 flex-col gap-2" variant="outline" disabled>
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground">Set up SMS sequence</div>
                </div>
              </Button>
              ...
              <Button className="h-24 flex-col gap-2" variant="outline" disabled>
                ...
                <div className="text-center">
                  <div className="font-semibold">Configure Sophie</div>
                  <div className="text-xs text-muted-foreground">AI settings & prompts</div>
                </div>
              </Button>
            </div>
          </CardContent>
