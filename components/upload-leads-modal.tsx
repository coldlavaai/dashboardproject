...
export function UploadLeadsModal({ open, onOpenChange, datasetId }: UploadLeadsModalProps) {
      ...
      <DialogContent className="max-w-2xl">
        ...
        {step === 'complete' && (
          <div className="py-12 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Leads imported successfully!</h3>
            <p className="text-sm text-muted-foreground">
